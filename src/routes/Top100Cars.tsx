...
function Top100Cars() {
  let cars = new Map<string, string>([
    ...
    ["Honda Integra Type-R (DC2)", require("../assets/jpeg/hondaintegratyperdc2.jpeg").default],
    ["Aston Martin DB7 Vantage", require("../assets/jpeg/astonmartindb7vantage.jpeg").default],
